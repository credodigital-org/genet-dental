      ...
      <div className="cta-wrap">
        <div className="cta-banner">
          ...
          <div className="cta-ghost" aria-hidden="true">
            <div className="cta-ghost-logo">
              <img src={logoIcon} alt="" />
              <span>GENET<br />DENTAL CENTER</span>
            </div>
            <h3>Achieve Your Perfect Smile Today!</h3>
            <p>Professional, Compassionate Care for the Whole Family</p>
            <span className="cta-ghost-pill">BOOK APPOINTMENT</span>
          </div>
