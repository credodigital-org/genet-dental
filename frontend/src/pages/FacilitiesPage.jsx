...
function ScannerIcon() {
  return (
    <svg
      ...
      strokeWidth="1.4"
    >
      <path d="M6 3v4M18 3v4M4 9h16l-2 5H6L4 9Z" />
  ...
  return (
    <>
      {/* <PageHero
        ...
        description="We use advanced technology and modern equipment to deliver precise, comfortable and effective dental care."
      /> */}
        ...
        <div className="wrap">
          {loading ? (
            ...
            <div className="api-error">
              Unable to load facilities from the server.
            </div>
          ) : (
